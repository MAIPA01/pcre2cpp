 ...
 */
#pragma once
#ifndef _PCRE2CPP_REGEX_COMPILE_OPTIONS_HPP_
	#define _PCRE2CPP_REGEX_COMPILE_OPTIONS_HPP_
...
namespace pcre2cpp {
	...
	static _PCRE2CPP_CONSTEXPR17 regex_compile_options operator|(const regex_compile_options_bits opt0,
	  const regex_compile_options_bits opt1) noexcept {
		return static_cast<regex_compile_options>(opt0) | static_cast<regex_compile_options>(opt1);
	}

	static _PCRE2CPP_CONSTEXPR17 regex_compile_options operator|(const regex_compile_options& opts,
	  const regex_compile_options_bits& opt) noexcept {
		return opts | static_cast<regex_compile_options>(opt);
	}
} // namespace pcre2cpp
	#endif
#endif